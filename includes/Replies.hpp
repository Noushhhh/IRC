...
#define	RPL_LIST(rplname, channel, topic)       rplname + "322 " + channel + " " + topic + "\n"
#define RPL_LISTEND(rplname)				    rplname + "323: end of LIST\n"
...
#define	RPL_NOTOPIC(rplname, channel)           rplname + "331 " + channel + ": No topic is set\n"
#define	RPL_TOPIC(rplname, channel, topic)      rplname + "332 " + channel + " " + topic + "\n"

//INVITE / 341

#define	RPL_INVITING(rplname, channel, nick)    rplname + "341 " + nick + ": Was succesfully invited to " + channel + "\n"
...
#define ERR_NONICKNAMEGIVEN(rplname)		    rplname + "431: No nickname given\n" //431
...
#define ERR_NOORIGIN(rplname)			            rplname + "409: No origin specified\n" // 409 for ping and pong
